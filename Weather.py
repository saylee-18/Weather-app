...
def data_get():
    city = city_name.get()
    data = requests.get("https://api.openweathermap.org/data/2.5/weather?q=" + city + "&appid=51639faad6b039417ecd183d6899ce90").json()
...
com= ttk.Combobox(win, text = "Wscube Weather App", values = list_name, font=("Times New Roman", 15, "bold"), textvariable=city_name)
...
w_label1.place(x=270, y=260, height=50, width=200)
...
wb_label1.place(x=270, y=330, height=50, width=200)
...
temp_label1.place(x=270, y=400, height=50, width=200)
...
per_label1.place(x=270, y=470, height=50, width=200)
